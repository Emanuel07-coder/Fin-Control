      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-lg max-h-[60vh] overflow-y-auto bg-near-black border border-gold-accent/20 rounded-xl shadow-subtle-lg z-50"
          >
            {/* Header */}
