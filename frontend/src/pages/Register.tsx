      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <User className="w-8 h-8 text-gold-accent" strokeWidth={1.5} />
          </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="name" className="label-uppercase mb-2 block">
                Nome
              </label>
              ...
              {errors.name && (
                <p className="mt-1.5 text-xs text-burgundy-text">{errors.name.message}</p>
              )}
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              {errors.email && (
                <p className="mt-1.5 text-xs text-burgundy-text">{errors.email.message}</p>
              )}
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              {errors.password && (
                <p className="mt-1.5 text-xs text-burgundy-text">{errors.password.message}</p>
              )}
            </motion.div>
